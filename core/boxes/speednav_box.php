 ...
 */
class speednavbox extends ModeleBoxes
{

    public $boxcode = "mybox";
    public $boximg = "speednav@speednav";
    public $boxlabel;
    public $depends = array("speednav");
    public $db;
    public $param;
    ...
    public function loadBox($max = 5)
    {
        ...
        //include_once DOL_DOCUMENT_ROOT . "/speednav/class/speednav.class.php";
